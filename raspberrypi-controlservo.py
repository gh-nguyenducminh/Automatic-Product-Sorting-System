...
#pwm.set_#pwm_frequency(servo1, 50)
#pwm.set_#pwm_frequency(servo2, 50) 
#pwm.set_#pwm_frequency(servo3, 50)               # cài tần số xung điều khiển cho servo
#pwm.set_#pwm_frequency(servo4, 50)
#pwm.set_#pwm_frequency(servo5, 50)
