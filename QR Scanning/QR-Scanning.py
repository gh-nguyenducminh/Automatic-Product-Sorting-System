...
firebase = firebase.FirebaseApplication('https://dk-canhtaymay-default-rtdb.asia-southeast1.firebasedatabase.app', None)
...
while True:
    ...
    for code in decode(frame):            #decode tung frame trong video
        ...
        if state == 0:
            firebase.put('/Mode', '/QR-Data', data)
            firebase.put('/Mode','/State', 1)
